...
public class MultiLevelMenueHandling {
...
//		level4.click();
		...
		//MultiLevelMenueHandle(level1Locator,"Beverages","Tea" ,"Green Tea");
		MultiLevelMenueHandle(level1Locator,"Baby Care","Baby Accessories" ,"Baby Toys");
	...
	public static void MultiLevelMenueHandle(By level1Locator,String level2,String level3,String level4 ) throws InterruptedException {
		Actions act = new Actions(driver);
	...
	public static void MultiLevelMenueHandle(By level1Locator,String level2,String level3  ) throws InterruptedException {
		Actions act = new Actions(driver);
		act.moveToElement(getElement(level1Locator)).perform();
		Thread.sleep(1500);
		act.moveToElement(getLinkEleByText(level2)).perform();
		Thread.sleep(1500);
		act.moveToElement(getLinkEleByText(level3)).click();
